            ...
            <div class="row no-gutters row-grid">
                <div class="col-12">
                    ...
                    <div class="d-flex flex-column align-items-center justify-content-center p-4">
                        <img src="/{{ ($user->profile->avatar)?? $avatarStub }}" class="rounded-circle shadow-2 img-thumbnail" alt=" avatar." width="100">
                        <h5 class="mb-0 fw-700 text-center mt-3">
                            {{ $user->name }}
                            <small class="text-muted mb-0"> {{ ($user->profile->job)?? '' }} </small>
                        </h5>
                ...
                <div class="col-12">
                    <div class="p-3 text-center">
                        ...
                        <address class="fs-sm fw-400 mt-4 text-muted">
                            <i class="fas fa-map-pin mr-2"></i> {{ ($user->profile->address)?? '' }}
                        </address>
                    </div>
                </div>
            </div>
